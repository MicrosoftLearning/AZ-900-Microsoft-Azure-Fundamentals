...
lab:
  ...
  description: In this exercise, you create an Azure storage container, upload a file
    to blob storage, and then configure blob storage to allow access to the file.
  duration: 15 minutes
  level: 200
  islab: true
  primarytopics:
